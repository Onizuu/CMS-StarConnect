...
router.get('/my-products', authenticate, async (req: AuthRequest, res) => {
    try {
...
router.post('/product', authenticate, async (req: AuthRequest, res) => {
    try {
...
router.put('/product/:id', authenticate, async (req: AuthRequest, res) => {
    try {
...
router.delete('/product/:id', authenticate, async (req: AuthRequest, res) => {
    try {
...
router.get('/donations/stats', authenticate, async (req: AuthRequest, res) => {
    try {
