...
export class CrisisService {
    static async getCrisisMode(userId: string) {
    ...
    static async updateCrisisTemplate(userId: string, data: {
        title: string;
        message: string;
    }) {
    ...
    static async activateCrisis(userId: string) {
    ...
    static async deactivateCrisis(userId: string) {
        return await prisma.crisisMode.update({
            where: { userId },
            data: {
                isActive: false,
    ...
    static async checkCrisisStatus(username: string) {
