...
export class CommentService {
    ...
    static async getContentComments(contentId, includePending = false) {
    ...
    static async getAllComments(userId, status) {
        return await prisma.comment.findMany({
            where: {
                content: {
                    userId,
    ...
    static async rejectComment(commentId, userId) {
        const comment = await prisma.comment.findUnique({
            where: { id: commentId },
            include: { content: true },
        });
    ...
    // Marquer comme spam
    static async markAsSpam(commentId, userId) {
        const comment = await prisma.comment.findUnique({
            where: { id: commentId },
            include: { content: true },
        });
    ...
    static async getCommentStats(userId) {
